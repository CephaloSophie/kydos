...
invitationRouter.post('/invitations/:id/cancel', requireAuthentication, asyncHandler((req, res) => invitationController.cancel(req, res)));
invitationRouter.get('/invitations/count', requireAuthentication, asyncHandler((req, res) => invitationController.countReceived(req, res)));

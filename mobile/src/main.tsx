...
router
  ...
  .register('robots',  RobotsScreen,        { title: 'Mes robots',   fanLabel: 'ROBOTS',   glyph: '♣', grad: 'var(--g-club)' })
  ...
  .register('compet',  CompetScreen,        { title: 'Compétitions', fanLabel: 'COMPÉT.',  glyph: '♦', grad: 'var(--g-diamond)' })

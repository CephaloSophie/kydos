/* =============================================================================
 * BACK-OFFICE · shared/robot-mascot.ts — Générateur SVG de mascotte (miroir).
 * Miroir FIDÈLE de packages/table-pixi/robotMascot.ts (mêmes deux familles,
 * antennes/mèches 1..5, états des yeux et de la bouche). À garder synchronisé.
 * ========================================================================== */
...
/** Libellés FR des états, pour les listes déroulantes du back-office. */
export const EYE_LABELS: Record<EyeState, string> = {
  'open': 'Ouverts', 'wide': 'Grands ouverts', 'closed': 'Fermés',
  'wink-left': 'Clin gauche', 'wink-right': 'Clin droit',
  'closed-left': 'Fermé à gauche', 'closed-right': 'Fermé à droite',
  'wide-left': 'Grand à gauche', 'wide-right': 'Grand à droite',
};
export const MOUTH_LABELS: Record<MouthState, string> = {
  'smile': 'Sourire', 'grin': 'Rictus', 'neutral': 'Neutre',
  'sad': 'Triste', 'angry': 'Colère', 'surprised': 'Surpris',
};
...
/** Rétrocompat. */
export function robotMascotSvg(face: RobotFace, size = 96): string { return mascotSvg(face, size); }
